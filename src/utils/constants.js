...
const greeting = {
  ...
  subTitle:
    "Enthusiastic and dedicated web developer with a strong foundation in the MERN (MongoDB, Express, React NodeJs) stack, seeking an entry-level position to contribute my skills and passion for creating innovative web applications. With a solid academic background and hands-on experience through various projects.",
  resume:
    "https://drive.google.com/file/d/1cDQ5eNFF17TsNAox3UdpDfYQnJsv_-iP/view?usp=sharing",
};
...
const myProjects = {
  ...
  projects: [
    ...
    },
    {
      ...
      projectDesc:
        "Social Circle is a Social media Application. Tech-Stack: HTML, CSS, JavaScript, React. Implemented features like Quick Login, Profile, News Feed, follow requests, etc. User-specific features like Edit Profile, Like post, Delete post, Bookmark posts, and Separate Personalised feed with sort. Implemented token-based authentication using JWT. Expansion aspects for adding comments.",
      footerLink: [
        {
          name: "github",
  ...
  projects: [
    {
      ...
      category: "Ecommerce",
      projectDesc:
        "Developed the frontend for a book e-commerce platform, integrating seamlessly with an existing backend. The app allows users to browse, add books to cart or wishlist, and sort books by Fiction, Non-Fiction, or Self-Help categories. Built with React, Redux Toolkit, and Tailwind CSS, ensuring a smooth, responsive, and optimized user experience",
      footerLink: [
        {
          name: "github",
    ...
    },
    {
      ...
      projectDesc:
        "Designed and developed this responsive portfolio website using React to showcase my personal projects and skills, featuring an intuitive, user-friendly interface. Built a mobile-first UI with optimized routing, and animated with GSAP and Framer Motion. Optimized for performance and accessibility, ensuring cross-browser compatibility, fast load times, and mobile responsiveness, following modern web development best practices.",
      footerLink: [
        {
          name: "github",
